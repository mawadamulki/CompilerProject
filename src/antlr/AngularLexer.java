...
public class AngularLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"TYPE", "INPUT", "PLACEHOLDER", "LBRACE", "RBRACE", "LBRACK", "RBRACK", 
			"LPAREN", "RPAREN", "COLON", "SEMI", "COMMA", "DOT", "ASSIGN", "QUOTE", 
			"DQUOTE", "PERCENT", "BACKTICK", "EXCLAMATION", "QUESTION", "WS", "BOOLEAN", 
			"RETURN", "STRING", "IDENTIFIER", "NUMBER", "TAG_OPEN", "TAG_CLOSE", 
			"SLASH", "HEXADECIMALCOLOR", "ATTR_NAME", "ATTR_VALUE", "OPERATION"
		};
	}
